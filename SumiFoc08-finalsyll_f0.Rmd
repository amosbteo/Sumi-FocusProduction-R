...
#title = (expression(paste("F0 at midpoint of final syllable after ", italic("=no")))))
  ...
  scale_fill_brewer(name="Sentence type",
          ...
          labels=c("transitive 'chase'", "intransitive 'sleep'"), palette="Greys") +
...
#Save as PNG file
png(file = "figures/SumiFoc_finalsyll50_focuspred_f0-bw.png", width = 500, height = 450, res = 72)
SumiFoc.finalsyll50.f0.plot2
dev.off()
```
...
SumiFoc.finalsyll.f0.traj1 <- ggplot(SumiFoc.finalsyll.f0.summ, aes(x = Time0, y = F0, group = interaction(Focus,Predicate))) + #Use x=Time for equal time
...
#Save as PNG file
png(file = "figures/SumiFoc_focustone_f0traj-bw.png", width = 500, height = 450, res = 72)
SumiFoc.finalsyll.f0.traj1
dev.off()
