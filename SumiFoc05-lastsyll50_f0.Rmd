...
SumiFoc.tone.f0.traj1 <- ggplot(SumiFoc.tone.f0.summ, aes(x = Time0, y = F0, shape = Focus, group = interaction(ToneCondition, Focus))) + #Use x=Time for equal time
  ...
  theme_bw() +
  scale_linetype_discrete(name = "Tone of syllable",
                        breaks = c("H", "M", "L"),
                        labels = c("High", "Mid", "Low")) +  
...
#Save as PNG file
png(file = "figures/SumiFoc_focustone_f0traj-bw2.png", width = 600, height = 450, res = 72)
SumiFoc.tone.f0.traj1
dev.off()
